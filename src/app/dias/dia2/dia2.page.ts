...
export class Dia2Page implements OnInit {
  ...
  showToast() {
    this.toastController.create({
      header: 'Informacion!!!',
      message: 'Combinar residuos orgánicos e inorgánicos en el aire libre, lo cual produce CO2 y METANO, gases causantes del calentamiento global y cambio climático.',
      position: 'middle',
